function [iht, ihbas, ihbasis] = makeRaisedCosBasis(nb, dt, endpoints,b, zflag)
% [iht, ihbas, ihbasis] = makeRaisedCosBasis(nh, hdt, endpoints, b, zflag);
%
...
elseif zflag == 2
    ...
    if isempty(ii)
        fprintf('WARNING: first basis vector is ZEROS  (makeRaisedCosBasis)\n');
    end
